...
parser.add_argument('-fp', '--filepath', default=os.path.join(os.curdir, 'logs', 'compression_test_result_quant_int8_64B_ebdi_inc.csv'),
...
plt.title("Compression Algorithm Test on activations of Pretrained and Quantized model (INT8)")
plt.legend()
plt.tight_layout()
plt.show()