...
if __name__ == '__main__':
    ...
    extractor_module = ModelExtractor(verbose=True, device='cpu')
    ...
    for model_type, model_config in imagenet_quant_pretrained.items():
        ...
        extractor_module.register_hook_by_type(torch.nn.intrinsic.quantized.modules.conv_relu.ConvReLU2d)
