...
parser.add_argument('-fp', '--filepath', default=os.path.join(os.curdir, '../logs', 'compression_test_final2_fp32_pr100.csv'),
...
plt.title("Compression Ratio of BDI Algorithms on Pretrained Models (INT8)")
plt.legend()
plt.tight_layout()
plt.show()