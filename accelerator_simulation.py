...
parser.add_argument('-wts', '--wgt-tile-shape',  default=(64, 64), help='Shape of a weight tile',                                 dest='wgt_tile_shape',  type=int, nargs=2)
parser.add_argument('-ats', '--act-tile-shape',  default=(64, 64), help='Shape of an input activation tile',                      dest='act_tile_shape',  type=int, nargs=2)
...
if __name__ == '__main__':
    ...
    ca_config = CompressedAcceleratorConfig(
        engine_num=engine_num, pe_num=pe_num, mult_num=mult_num, chunk_size=chunk_size, fifo_capacity=fifo_capacity)
